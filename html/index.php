    ...
    <div class="indexdoos1" id='homepage-header'>
        <div class="indexblok1">
            <div class="indexbalk1">
                <div onclick="selection('hideindexbalkbutton', 'indexbalkbutton1')" class="indexbalkbutton"><a class="indexbuttontekst1">Landen</a></div>
            ...
            <div class="indexblok2">
                ...
                <div class="indexbalkbutton5 hideindexbalkbutton"><div class="indexbloktekst"><a class="indextekst2">3 dingen die je moet weten over ons boekingbureau.</a>
                <a class="indextekst2">Minderjarige moeten minstens een ouder/voogd meenemen op vluchten.</a>
                <a class="indextekst2">Een all-inclusive moet tenminste 3 weken van tevoren geannuleert worden.</a>
